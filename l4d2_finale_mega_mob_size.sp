...
public Plugin myinfo =
{
    ...
    version = "1.0",
    description = "Silently change z_mega_mob_size during finales, only in custom campaigns."
};
...
public void OnPluginStart()
{
    ...
    g_cvCustomOnly   = CreateConVar("l4d2_finale_megamob_customonly", "1",  "Only change cvar in custom (non-Valve) campaigns", FCVAR_NOTIFY, true, 0.0, true, 1.0);
